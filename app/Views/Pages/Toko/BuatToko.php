...
<div class="container mt-3"  style="max-width:1000px; margin:auto; background-color:white">
  <div class="row ">
    <div class="col">
      <form class="" action="<?=base_url('public/Pages/EditProduk') ?>" method="post" enctype="multipart/form-data">
        ...
        <textarea class="k-textarea" name="Deskripsi" rows="3" cols="80"required></textarea><br>
