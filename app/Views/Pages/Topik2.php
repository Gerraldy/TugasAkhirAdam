...
<div class="container" style="max-width:800px; margin:auto">
  <div class="row">
      <div class="col-12" style="">
        <text style="font-size:12px; color:grey">Ting Ting Ting~ Soooooo baksooooo~</text>
        <div class="col-12" style="">
          <h4>Diskusi Pemerintah!</h4>
          <div class="" style="">
            <div class=" section-foto" style="position:relative;">
              <img src="<?= base_url('public/gambar/pemerintah.jpg')?>" class="img-fluid">
