    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="<?=base_url('/public/Admin/Dashboard') ?>">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?=base_url('/public/Admin/MasterTopik')?>">
                    <i class="fas fa-fw fa-table"></i>
                    <span>Master Topik</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?=base_url('/public/Admin/LaporanBanAkun')?>">
                    <i class="fas fa-fw fa-table"></i>
                    <span>Memers Ban</span></a>
            </li>
